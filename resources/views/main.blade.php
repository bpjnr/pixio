...
<html>
    <head>
        <title>Pixio | Photo sharing script</title>
        <meta charset="utf-8">
        <meta content="ie=edge" http-equiv="x-ua-compatible">
        <meta content="Pixio | Photo sharing script" name="keywords">
        <meta content="Pixio | Photo sharing script" name="author">
        <meta content="Pixio | Photo sharing script" name="description">
